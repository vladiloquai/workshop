class AddFieldsToIncident < ActiveRecord::Migration
  def change
    ...
    add_column :incidents, :creator_id, :integer
    add_column :incidents, :assigned_id, :integer
    add_column :incidents, :requester_id, :integer
    add_column :incidents, :finisher_id, :integer
